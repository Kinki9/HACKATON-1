...
const GroupsSection = ({ onNewGroup }) => {
  ...
  return (
    <section className="mb-10">
      <h2 className="text-2xl font-semibold mb-4 text-gray-500">Grupos de Trabajo</h2>
      <p className="text-gray-500 mb-4">Crea o únete a grupos de colaboración por área especializada.</p>
      ...
      <div className="mb-4">
        <input
          ...
          className="w-full md:w-1/2 border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 text-gray-700"
      ...
      >
        ...
        <input
          ...
          className="w-full border border-gray-300 rounded px-3 py-2 mb-3 focus:outline-none focus:ring-2 focus:ring-indigo-500 text-gray-700"
          required
        ...
        <textarea
          ...
          onChange={handleChange}
          rows={3}
          className="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 text-gray-700"
          required
